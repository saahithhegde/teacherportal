...
// TODO
//
// This appears to be using the obj.scale variable to get scale
// information. This is fine for the HBar, but not so good for the
// Scatter when it [will] have an X axis scale
